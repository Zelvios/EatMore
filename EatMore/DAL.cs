...
namespace EatMore
{
    public class DAL
    {
        ...
        public DAL()
        {
            ...
            //DataBasePizza.Add(new Pizza(MenuID++, MenuNummer++, "Pepperoni", new ObservableCollection<Top>() { toppingsliste[0], toppingsliste[1], toppingsliste[3] }, BasePrisPizza, 1));

            //DataBasePizza.Add(new Pizza(MenuID++, MenuNummer++, "Rejer", new ObservableCollection<Top>() { toppingsliste[0], toppingsliste[1], toppingsliste[18], toppingsliste[19] }, BasePrisPizza, 1));

            //DataBasePizza.Add(new Pizza(MenuID++, MenuNummer++, "Skinke", new ObservableCollection<Top>() { toppingsliste[0], toppingsliste[1], toppingsliste[18] }, BasePrisPizza, 1));

            //DataBasePizza.Add(new Pizza(MenuID++, MenuNummer++, "Genova", new ObservableCollection<Top>() { toppingsliste[0], toppingsliste[1], toppingsliste[20], toppingsliste[21], toppingsliste[39] }, BasePrisPizza, 1));

            //DataBasePizza.Add(new Pizza(MenuID++, MenuNummer++, "Sadig", new ObservableCollection<Top>() { toppingsliste[0], toppingsliste[1], toppingsliste[20], toppingsliste[22], toppingsliste[3], toppingsliste[39] }, BasePrisPizza, 1));

            //DataBasePizza.Add(new Pizza(MenuID++, MenuNummer++, "Be a Man", new ObservableCollection<Top>() { toppingsliste[0], toppingsliste[1], toppingsliste[20], toppingsliste[22], toppingsliste[24], toppingsliste[25], toppingsliste[28], toppingsliste[29], toppingsliste[36] }, BasePrisPizza, 1));
            ...
            //{
            //    DataBasePizza.Add(new Pizza(item.ID, , item.Navn, item.))
            //}
